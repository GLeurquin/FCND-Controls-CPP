...
public:
  ...
  void            OnSensor_IMU(V3F accel,
                               V3F gyros);
  void            OnSensor_OpticalFlow(float x,
                                       float y);
  ...
  void            OverrideEstimates(V3F              pos,
                                    V3F              vel,
  ...
  void                  SetTrajectoryOffset(V3F trajOffset) {
    _trajectoryOffset = trajOffset;
  }

  void SetTrajTimeOffset(float timeOffset) {
    _trajectoryTimeOffset = timeOffset;
  }
